    ...
    return(
        <form className='mt-4'>
            ...
            <div className='flex justify-center'>
                <button type='submit' onClick={handleDelete} className="text-white text-2xl font-medium px-5 py-2.5 rounded-md text-center dark:bg-red-600 dark:hover:bg-red-700">
                    Delete User
                </button>
            </div>
