...
function RegisterForm() {
  ...
  return (
    <form className="mt-4">
      <div>
        <label className="block text-xl font-semibold mt-6 mb-1">Username</label>
      ...
      <div>
        <label className="block text-xl font-semibold mt-6 mb-1">Email</label>
        <div className="relative">
          <MdEmail
            size={20}
            color="black"
      ...
      <div>
        <label className="block text-xl font-semibold mt-6 mb-1">Password</label>
        <div className="relative">
