...
function InputBox({ value, placeholder, onChange, type }: InputBoxProps) {
  return (
    <div className="relative w-full min-w-[200px] h-11 ">
      <input
        className="bg-white w-full h-full px-3 py-3 font-sans text-sm font-normal transition-all bg-transparent border rounded-md peer text-gray-700 outline outline-0 focus:outline-0 disabled:bg-gray-50 disabled:border-0 placeholder-shown:border placeholder-shown:border-gray-200 placeholder-shown:border-t-gray-200 focus:border-2 border-t-transparent focus:border-t-transparent border-gray-200 focus:border-gray-900"
        placeholder=" "
        value={value}
