  ...
  return (
    <div className="w-[400px] h-[420px] shadow-md rounded-2xl">
      <div className="px-10 py-5">
        <h1 className="font-bold text-xl">Current Study Session:</h1>
        ...
        <div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-[16px] font-semibold">Goal</h2>
          </div>
        </div>
        <div className="text-right">
          <h1 className="text-xl font-bold">1hr 20mins</h1>
          <div className="flex items-center space-x-3 justify-end">
            <h2 className="text-[16px] font-semibold">This session</h2>
